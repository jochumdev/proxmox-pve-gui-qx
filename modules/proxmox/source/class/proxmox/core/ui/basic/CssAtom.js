 ...
 */
qx.Class.define("proxmox.core.ui.basic.CssAtom",
{
  ...
  */
   ...
   */
  construct : function(label, iconCssClasses)
  {
  ...
  members :
  {
    ...
    _createChildControlImpl : function(id, hash)
    {
      ...
      switch(id)
      {
        ...
        case "icon":
          var cssClasses = this.getIconCssClasses();
          if (Array.isArray(cssClasses)) {
            control = new proxmox.core.ui.basic.CssImage(cssClasses);
          } else {
            control = new qx.ui.basic.Image(cssClasses);
          }

          control.setAnonymous(true);
          this._addAt(control, 0);
          if (this.getIconCssClasses() == null || this.getShow() === "label") {
            control.exclude();
          }
          break;
      }
