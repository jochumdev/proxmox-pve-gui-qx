qx.Class.define("proxmox.core.page.Navigator", {
    ...
    members: {
        ...
        setPageView: function (routeParams) {
            ...
            if (!qx.Class.implementsInterface(view, proxmox.core.page.core.IView)) {
                throw new Error("View doesn't implement proxmox.core.page.core.IView");
            }
