 ...
 */
qx.Class.define("pvem.Application", {
    ...
    */
    ...
    members: {
        ...
        main: function () {
            ...
            // Init p.application.MApplication
            this.initcore();
            ...
            var inputPage = this.__inputPage = new pvem.page.Input();
            ...
            var tweetsPage = new pvem.page.Tweets();
            ...
            var tweetPage = new pvem.page.TweetDetail();
