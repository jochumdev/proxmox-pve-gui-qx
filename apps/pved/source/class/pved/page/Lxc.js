qx.Class.define("pved.page.Lxc", {
    ...
    members: {
        ...
        _init: function() {
             ...
             */
            this._tbStartButton = new p.ui.form.CssButton(this.tr("Start"), ["fa", "fa-play"]);
        ...
        _getContentContainer: function () {
            ...
            toolbar.add(new p.ui.form.CssButton(this.tr("More")));
            toolbar.add(new p.ui.form.CssButton(this.tr("Help"), ["fa", "fa-question-circle"]));

            var navbar = new pved.part.Navbar("lxc");
        ...
        _getSubPage: function(pageId) {
            ...
            switch(pageId) {
                case "summary":
                    subPage = new pved.page.lxc.Summary();
                    break;
                case "console":
                    subPage = new pved.page.lxc.Console();
                    break;
                default:
                    return false;
            }
