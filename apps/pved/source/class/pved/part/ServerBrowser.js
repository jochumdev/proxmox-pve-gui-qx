qx.Class.define("pved.part.ServerBrowser", {
    extend: qx.core.Object,
    implement: p.part.IPart,
    include: [
    ...
    construct: function () {
        ...
        var tree = this._tree = new p.ui.tree.VirtualTree(null, "label", "children");
        ...
        tree.setDelegate({
            ...
            // delegate implementation
            createItem: function () {
                return new pved.ui.ServerBrowserTreeItem();
            }
        });
