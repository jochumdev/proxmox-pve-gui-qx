qx.Class.define("proxmox.ve.desktop.page.Node", {
    ...
    members: {
        _getContentContainer: function () {
            ...
            actionsBar.add(new proxmox.core.ui.form.CssButton(this.tr("Start"), ["fa", "fa-book"]));
            actionsBar.add(new proxmox.core.ui.form.CssButton(this.tr("Shutdown"), ["fa", "fa-power-off"]));
            actionsBar.add(new proxmox.core.ui.form.CssButton(this.tr("Migrate"), ["fa", "fa-paper-plane-o"]));
            actionsBar.add(new proxmox.core.ui.form.CssButton(this.tr("Console"), ["fa", "fa-terminal"]));
            actionsBar.add(new proxmox.core.ui.form.CssButton(this.tr("More"), ["fa", "fa-book"]));
            actionsBar.add(new proxmox.core.ui.form.CssButton(this.tr("Help"), ["fa", "fa-question-circle"]));

            var navbar = new proxmox.ve.desktop.part.Navbar("node");
        ...
        _getSubPage: function(pageId) {
            ...
            switch(pageId) {
                case "summary":
                    subPage = new proxmox.ve.desktop.page.node.Summary();
                    break;
                default:
                    return false;
            }
